...
describe("node-require", () => {
    it("should consolidate using both extension and extensions", () => {
    ...
    it("should consolidate using only extensions", () => {
        testNodeRequireInstall(
            {
                extensions: [".marko", ".html"]
            },
    ...
    it("should consolidate using only extension", () => {
        testNodeRequireInstall(
            {
                extension: ".marko.xml"
            },
    ...
    it("should consolidate using extension and empty array of extensions", () => {
        testNodeRequireInstall(
            {
                extension: ".marko.xml",
                extensions: []
    ...
    it("should consolidate with .marko when neither extension or extensions provided", () => {
        testNodeRequireInstall({}, [".marko"]);
    });

    it("should insert missing period into extensions", () => {
        testNodeRequireInstall(
            {
                extension: "marko.xml",
                extensions: ["html"]
